...
X = pd.read_csv('C:\\Users\\chitra\\Desktop\\TU-Delft\\Information Retrival\\movie-reviews\\word_vectors_training.csv')
...
value = [0]*10 #trying for the first 10 samples, can increase the array size
for i in range(10):
...
#df1 = pd.DataFrame(X)
centroids, labels, inertia = cluster.k_means(value, n_clusters = 4)
